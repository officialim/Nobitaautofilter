    ...
    if temp.ME in r_j_check:
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                caption=f"🔖 ʜᴇʟʟᴏ ᴍʏ ғʀɪᴇɴᴅ {u.mention},\n🪬 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴏᴜʀ ɢʀᴏᴜᴘ.{message.chat.title} !\n\n📟 ᴛʜɪs ɪs ᴍᴏᴠɪᴇ & sᴇʀɪᴇs ɢʀᴏᴜᴘ. 🎞️ ᴀʟʟ ᴄᴀᴛᴇɢᴏʀɪᴇs ᴏꜰ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs ᴀᴠᴀɪʟᴀʙʟᴇ ʜᴇʀᴇ  📝 ᴊᴜsᴛ ᴛʏᴘᴇ ᴛʜᴇ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ [ᴄᴏʀʀᴇᴄᴛ sᴘᴇʟʟɪɴɢ]. 🗞️ ʙᴏᴛ ᴡɪʟʟ sᴇɴᴅ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ  👇🏻 ᴘʟᴇᴀsᴇ ʀᴇᴀᴅ ɢʀᴏᴜᴘ ʀᴜʟᴇs",
                reply_markup=InlineKeyboardMarkup(buttons))
